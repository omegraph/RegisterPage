...
namespace _06_RepositoryPattern_Tests
{
    ...
    public class StreamingContentRepositoryTests
    {
        ...
        public void Arrange()
        {
            ...
            _content = new StreamingContent("Rubber", "A car type comes to life with the power to make people explode and goes on a murderous rampage through the Californian desert.", "R", 5.8, false, GenreType.Drama);
        ...
        public void UpdateExistingContent_ShouldReturnTrue()
        {
            // Arrange
            //TestInitialize
            StreamingContent newContent = new StreamingContent("Rubber", "A car type comes to life with the power to" +
                "make people explode and goes on a murderous rampage through the Californian desert.", "R", 10, false,
                GenreType.RomCom);
